...
//   return (
//     <section className="relative pt-22 md:pt-24 lg:pt-32 pb-12 md:pb-16 lg:pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
...
//         <div className="absolute top-10 md:top-20 right-0 w-48 h-48 md:w-64 md:h-64 lg:w-96 lg:h-96 bg-cyan-200 rounded-full mix-blend-multiply filter blur-xl md:blur-2xl lg:blur-3xl opacity-20 md:opacity-30 animate-pulse"></div>
//         <div
//           className="absolute bottom-0 left-0 w-48 h-48 md:w-64 md:h-64 lg:w-96 lg:h-96 bg-blue-200 rounded-full mix-blend-multiply filter blur-xl md:blur-2xl lg:blur-3xl opacity-20 md:opacity-30 animate-pulse"
//           style={{ animationDelay: '1000ms' }}
//         ></div>
//         <div
//           className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-48 h-48 md:w-64 md:h-64 lg:w-96 lg:h-96 bg-cyan-100 rounded-full mix-blend-multiply filter blur-xl md:blur-2xl lg:blur-3xl opacity-10 md:opacity-20 animate-pulse"
...
//           {/* Left Content - Responsive Text & Spacing */}
...
//             <div className="bg-white/90 backdrop-blur-md p-3 md:p-4 lg:p-5 rounded-2xl shadow-xl border border-cyan-100 w-full max-w-md">
...
//           {/* Right Image Section - Responsive positioning */}
//           <div className="relative mt-8 lg:mt-0 animate-in slide-in-from-right duration-700 delay-300">
//             <div className="absolute inset-0 bg-gradient-to-r from-[#B964DD] to-[#F849C1] rounded-full filter blur-xl md:blur-2xl lg:blur-3xl opacity-10 md:opacity-20 animate-pulse"></div>
//             <div className="relative">
//               <div className="relative bg-gradient-to-br from-white to-cyan-50 rounded-2xl md:rounded-3xl p-2 md:p-3 shadow-xl md:shadow-2xl">
...
//               <div className="absolute -bottom-4 -right-4 md:-bottom-6 md:-right-6 bg-white p-3 md:p-4 rounded-xl md:rounded-2xl shadow-lg md:shadow-xl border border-cyan-100">
...
export default function Hero() {
  return (
    <section className="relative pt-16 max-sm:pt-22 md:pt-24 lg:pt-32 pb-12 md:pb-16 lg:pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      {/* Background Gradient with Responsive Blobs */}
      <div className="absolute inset-0 bg-gradient-to-br from-cyan-50 via-blue-50 to-white">
        <div className="absolute top-10 md:top-20 right-0 w-48 h-48 md:w-64 md:h-64 lg:w-96 lg:h-96 bg-cyan-200 rounded-full mix-blend-multiply filter blur-xl md:blur-2xl lg:blur-3xl opacity-20 md:opacity-30 animate-pulse"></div>
        <div
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-10 lg:gap-12 items-center max-sm:gap-5">
          ...
          <div className="lg:hidden space-y-6 md:space-y-8">
            ...
            {/* Heading */}
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold leading-tight md:leading-tight max-sm:mb-2">
              Get Unparalleled{' '}
              <span className="relative inline-block">
                <span className="bg-gradient-to-r from-[#B964DD] to-[#F849C1] bg-clip-text text-transparent">
                  Skin Results
          ...
          <div className="lg:hidden space-y-6">
            ...
            {/* Stats Card */}
            <div className="bg-white/90 backdrop-blur-md p-3 md:p-4 rounded-2xl shadow-xl border border-cyan-100 w-full">
              <div className="flex flex-col sm:flex-row items-center gap-3 md:gap-4">
                <div className="flex -space-x-2 md:-space-x-3">
                  {icons.map((Icon, index) => (
                    <div
