...
// const cards = [
//   {
//     image: "https://cdn.coverr.co/videos/coverr-woman-with-facial-mask-3815/1080p.mp4",
//     title: "Pigmentation & Dark Spots",
//     btn: "Reduce Pigmentation",
//   },
//   {
//     image:   "https://cdn.coverr.co/videos/coverr-skin-care-routine-6766/1080p.mp4",
//     title: "Anti-Aging & Wrinkles",
//     btn: "Anti-Aging Treatment",
//   },
//   {
//     image:   "https://cdn.coverr.co/videos/coverr-applying-face-cream-9510/1080p.mp4",
//     title: "Skin Rejuvenation",
//     btn: "Rejuvenate Skin",
//   },
//   {
//     image:   "https://cdn.coverr.co/videos/coverr-relaxing-facial-treatment-4106/1080p.mp4",
...
//                 } px-3`}
//               >
//                 <div className="rounded-2xl lg:rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 bg-white border border-gray-100 group">
//                   <video
//                     src={card.image}
//                     // alt={card.title}  src={videos[0]}
//                     autoPlay
//                     loop
//                     muted
//                     playsInline
//                     className="w-full h-110 md:h-120 lg:h-120 object-cover group-hover:scale-105 transition-transform duration-700 "
...
const cards = [
  ...
  {
    video: "https://cdn.coverr.co/videos/coverr-skin-care-routine-6766/1080p.mp4",

    btn: "Anti-Aging Treatment",
  },
  {
    video: "https://cdn.coverr.co/videos/coverr-applying-face-cream-9510/1080p.mp4",
