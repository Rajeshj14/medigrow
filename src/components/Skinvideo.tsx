...
const SkinBeforeAfterCarousel = () => {
  ...
  return (
    ...
    >
      {/* HEADING */}
      <div className="text-center max-w-3xl mx-auto mb-8 max-sm:mb-4 px-4">
      ...
      <div className="relative max-w-6xl mx-auto px-4">
        ...
        <div 
          ref={carouselRef}
          className="overflow-hidden p-3 max-sm:p-0 max-sm:pb-2"
        >
          <div
              ...
              >
                <div className="rounded-2xl lg:rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 bg-white border border-gray-100">
                  <img
                    ...
                    className="w-full h-94 md:h-72 lg:h-100 object-cover hover:scale-105 transition-transform duration-700"
                    loading="lazy"
                  />
                </div>
              </div>
