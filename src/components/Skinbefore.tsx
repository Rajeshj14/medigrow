    ...
    >
      ...
      {!isPlaying && (
        <div 
          ...
          onClick={togglePlay}
        >
          <div className="bg-white/90 backdrop-blur-sm rounded-full p-4 hover:scale-110 transition-transform">
        ...
        <div className="flex items-center justify-between text-white text-sm">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="relative">
              ...
              {/* Dropdown Menu */}
              {showMenu && (
                <div className="absolute bottom-full right-0 mb-2 bg-gray-900 rounded-lg shadow-xl py-2 min-w-[150px] z-50">
                  {/* Playback Speed */}
                  <div className="relative">
                    <button
                    ...
                    {showSpeedMenu && (
                      <div className="absolute right-full top-0 mr-2 bg-gray-900 rounded-lg shadow-xl py-2 min-w-[100px]">
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-4">
        ...
        >
          <svg className="w-5 h-5 md:w-6 md:h-6 text-gray-800 group-hover:text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
